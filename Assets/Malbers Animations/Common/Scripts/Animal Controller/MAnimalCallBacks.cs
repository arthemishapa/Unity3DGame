...
namespace MalbersAnimations.Controller
{
    ...
    public partial class MAnimal
    {
        ...
        public virtual void State_Enable(int ID)
        {
            ...
            if (statesD.TryGetValue(ID, out s))
            {
                s.Active = true;
            }
            else
        ...
        public virtual bool State_TryActivate(int ID)
        {
            ...
            if (statesD.TryGetValue(ID, out NewState))
            {
                ...
                if (!NewState.Active || NewState.IsSleepFromState || NewState.IsSleepFromMode) return false;           //if the New state is disabled or os sleep ignore Activation
        ...
        public virtual void State_Activate(int ID)
        {
            ...
            if (statesD.TryGetValue(ID, out NewState))
            {
                ...
                if (!NewState.Active || NewState.IsSleepFromState || NewState.IsSleepFromMode) return;             //if the New state is disabled or os sleep ignore Activation
