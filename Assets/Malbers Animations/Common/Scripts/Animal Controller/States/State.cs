    ...
    public abstract class State : ScriptableObject 
    {
     ...
     // bool HasEnterState;
        ...
        public void ActivatebyInput(bool InputValue)
        {
            ...
            if (!Active || IsSleepFromState || IsSleepFromMode || animal.LockInput || activeState.IsPersistent) return;    //Do no Activate if is sleep or disable or lock input is Enable;
