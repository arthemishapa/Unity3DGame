...
namespace MalbersAnimations.Controller
{
    ...
    public class MAnimalEditor : Editor 
    {
      ...
      //  private ReorderableList Reo_List_Pivots;
        ...
        SerializedProperty
            S_StateList, S_PivotsList, Height, S_Mode_List, Editor_Tabs1, Editor_Tabs2, /*ModeIndexSelected,*/ OnEnterExitStances, ModeShowAbilities, OnEnterExitStates, RB,Anim, //PivotPosDir,
            ...
            alwaysForward, triggerInteraction, AnimatorSpeed, OnMovementLocked, OnInputLocked, OnSprintEnabled, OnGrounded, OnStanceChange, OnStateChange, OnModeChange,
        ...
        private void ShowGeneral()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    m.AlwaysForward = m.AlwaysForward;
                }
        ...
        private void DrawHeaderCallback_Pivots(Rect rect)
        {
            ...
            //PivotPosDir.intValue = GUI.Toolbar(poss, PivotPosDir.intValue, new string[] { "Position", "Direction"}, EditorStyles.toolbarButton);
            //Rect R_2 = new Rect(rect.width -7, rect.y + 2, 18, EditorGUIUtility.singleLineHeight - 3);
            //Rect R_3 = new Rect(rect.width + 13, rect.y + 2, 18, EditorGUIUtility.singleLineHeight - 3);
        ...
        private void Draw_Header_Modes(Rect rect)
        {
            ...
            //Rect R_2 = new Rect(rect.width - 7, rect.y + 2, 20, EditorGUIUtility.singleLineHeight - 3);
            //Rect R_3 = new Rect(rect.width + 13, rect.y + 2, 20, EditorGUIUtility.singleLineHeight - 3);
